...
ETF_COUNTRY_TO_TICKERS: dict[str, list[str]] = {
    "Australia": ["IAUS.L", "SAUS.L", "EWA"],
    "Austria": ["EWO", "CSAU.DE"],
    "Belgium": ["EWK", "CBEG.DE"],
    "Brazil": ["XMBR.L", "EWZ"],
    "Bulgaria": ["BGX.L"],
    "Canada": ["CSCA.L", "EWC"],
    "China": ["CNYA.L", "IASH.L", "FRCH.L", "MCHI"],
    "France": ["ISFR.L", "EWQ"],
    "Germany": ["XDAX.L", "EWG"],
    "Greece": ["0IWZ.L", "GREK"],
    "Hong Kong": ["EWH", "HKAS.DE"],
    "India": ["IIND.L", "FRIN.L", "NDIA.L", "INDA"],
    "Indonesia": ["INDO.L", "EIDO"],
    "Italy": ["CMIB.L", "EWI"],
    "Japan": ["CJPU.L", "LCJP.L", "EWJ"],
    "Kuwait": ["MKUW.L", "KWT"],
    "Malaysia": ["XCX3.L", "EWM"],
    "Mexico": ["XMEX.L", "EWW"],
    "Netherlands": ["EWN", "IQQA.DE"],
    "Pakistan": ["XBAK.L"],
    "Philippines": ["XPHG.L", "EPHE"],
    "Poland": ["SPOL.L", "IPOL.L", "EPOL"],
    "Saudi Arabia": ["IKSA.L", "KSA"],
    "Singapore": ["SESP.L", "0JLR.L", "EWS"],
    ...
    "United States": ["VUAA.L", "CSPX.L", "VUSA.L", "CSUS.L"],
    "Vietnam": ["XFVT.L", "VNAM"],
}
