...
def main() -> None:
    ...
    parser.add_argument("--etf-csv", default="etf_prices.csv")
    parser.add_argument("--weo-csv", default="weo_gdp.csv")
    parser.add_argument("--output", default="etf_weo_combined_annual.csv")
